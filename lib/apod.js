...
export function describeApod(apod) {
  if (!apod) return "I couldn't reach NASA's picture of the day.";
  const kind = apod.isVideo ? "video" : "picture";
  return `NASA's ${kind} of the day is "${apod.title}".`;
}
